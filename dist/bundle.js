...
/* harmony import */ var _src_utils_web3Utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./src/utils/web3Utils */ "./src/utils/web3Utils.js");
...
function checkSpecialEffectsAccess() {
  return _checkSpecialEffectsAccess.apply(this, arguments);
}
function _checkSpecialEffectsAccess() {
  _checkSpecialEffectsAccess = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var baseTokenOwned, baseTokenOwned2;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0,_src_utils_web3Utils__WEBPACK_IMPORTED_MODULE_10__.checkTokenOwnership)("0x1dd4245bc6b1bbd43caf9a5033e887067852123d", "base");
        case 3:
          baseTokenOwned = _context.sent;
          _context.next = 6;
          return (0,_src_utils_web3Utils__WEBPACK_IMPORTED_MODULE_10__.checkTokenOwnership)("0x39e6EED85927e0203c2ae9790eDaeB431B8e43c1", "base");
        case 6:
          baseTokenOwned2 = _context.sent;
        ...
        case 11:
          ...
          console.error("Error checking token ownership:", _context.t0);
...
var Enemy = /*#__PURE__*/function () {
  function Enemy() {
    ...
    var geom = hasSpecialEffects ? new THREE.PlaneGeometry(24, 24) : new THREE.TetrahedronGeometry(8);
    var mat = hasSpecialEffects ? new THREE.MeshPhongMaterial({
      color: 0xffffff,
      map: projectileTexture,
      transparent: true,
...
function _connectWallet() {
  _connectWallet = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
    var userAddress, hasToken, event;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 16:
          ...
          event = new CustomEvent("walletStatusChanged", {
            detail: {
              userAddress: userAddress,
              hasToken: hasToken
            }
...
function _initializeWalletConnect() {
  _initializeWalletConnect = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee11() {
    var savedWalletState, _JSON$parse, userAddress, hasToken, accounts;
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        ...
        case 6:
          ...
          savedWalletState = localStorage.getItem("walletState");
          if (!savedWalletState) {
            _context11.next = 19;
            break;
          }
          _JSON$parse = JSON.parse(savedWalletState), userAddress = _JSON$parse.userAddress, hasToken = _JSON$parse.hasToken;
        ...
        case 22:
          ...
          console.log("WalletConnect initialization failed, continuing with limited functionality");
        case 25:
        case "end":
...
var SelectionManager = /*#__PURE__*/function () {
  function SelectionManager() {
    ...
    var savedWalletState = localStorage.getItem("walletState");
    if (savedWalletState) {
      var _JSON$parse = JSON.parse(savedWalletState),
        userAddress = _JSON$parse.userAddress,
        hasToken = _JSON$parse.hasToken;
  ...
  return _createClass(SelectionManager, [{
    ...
    value: function () {
      var _initSelectionScreen = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        var _this2 = this;
        var pilotOptionsContainer, aircraftOptionsContainer;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
    ...
    key: "updateSelectionOptions",
    value: function updateSelectionOptions() {
      var _this6 = this;
    ...
    key: "setupInfoModal",
    value: function setupInfoModal() {
      var infoIcon = document.getElementById("selection-info");
      ...
      infoIcon.addEventListener("click", function (e) {
        ...
        modalContainer.style.top = "".concat(iconRect.bottom + 10, "px");
        modalContainer.style.left = "".concat(iconRect.left, "px");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   checkSpecialEffectsAccess: () => (/* binding */ checkSpecialEffectsAccess),
/* harmony export */   checkTokenOwnership: () => (/* binding */ checkTokenOwnership)
/* harmony export */ });
...
var BASE_CONTRACT = "0x1dd4245bc6b1bbd43caf9a5033e887067852123d";
var BASE_CONTRACT_2 = "0x39e6EED85927e0203c2ae9790eDaeB431B8e43c1";
var CONTRACT_ABI = [{
  inputs: [{
    name: "account",
    type: "address"
...
function _getProvider() {
  _getProvider = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(network) {
    var web3;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
function checkTokenOwnership(_x2, _x3) {
  return _checkTokenOwnership.apply(this, arguments);
}
function _checkTokenOwnership() {
  _checkTokenOwnership = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(contractAddress, network) {
    var web3, accounts, address, contract, balance;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          console.log("Checking ownership for contract ".concat(contractAddress, " on ").concat(network));
          _context2.next = 4;
        ...
        case 12:
          ...
          console.log("Balance for ".concat(contractAddress, ": ").concat(balance));
          return _context2.abrupt("return", BigInt(balance) > 0n);
        case 17:
          _context2.prev = 17;
          _context2.t0 = _context2["catch"](0);
          console.error("Error in checkTokenOwnership for ".concat(contractAddress, ":"), _context2.t0);
...
function _checkSpecialEffectsAccess() {
  _checkSpecialEffectsAccess = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var baseOwnership, baseOwnership2;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return checkTokenOwnership(BASE_CONTRACT, "base");
        case 3:
          baseOwnership = _context3.sent;
          _context3.next = 6;
        ...
        case 10:
          ...
          console.error("Error checking special effects access:", _context3.t0);
